	...
	<div class="custom_signup">
		...
		<form method="POST" action="{{route('teacher.update', $teacher -> id)}}" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
		    ...
		    <input name="name" value="{{$teacher -> name}}" type="text" class="form-control" id="exampleInputName1" aria-describedby="emailHelp">
		  </div>
		  <div class="form-group">
		    <label for="exampleInputEmail1">Email</label>
		    <input name="email" value="{{$teacher -> email}}" type="text" class="form-control" id="exampleInputEmail1">
		  </div>
		   <div class="form-group">
		    <label for="cell">Cell</label>
		    <input name="cell" value="{{$teacher -> cell}}" type="text" class="form-control" id="cell">
		  </div>
            <div class="form-group">
                <label for="age">Age</label>
                <input name="age" value="{{$teacher -> age}}" type="text" class="form-control" id="age">
            </div>
            <div class="form-group">
                <img src="{{URL::to('/')}}/media/teacher/{{$teacher -> photo}}" alt="" class="img-fluid">
